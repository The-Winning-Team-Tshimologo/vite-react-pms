    ...
    return (
        <div className="flex-col">
            ...
            <h1>Application</h1>
                ...
                <input className="application_input"
            ...
            <label htmlFor="PhysicalAdress" className="offscreen"> Physical Adress </label>
            <input className="application_input"
                type="text"
                id="PhysicalAdress"
                name="PhysicalAdress"
            ...
            <label htmlFor="Streetname" className="offscreen">Street Name</label>
            <input className="application_input"
                type="text"
                id="Streetname"
                name="Streetname"
            ...
            <select className="application_input"
                id="MainService"
                name="MainService"
            ...
            <label htmlFor="experience">How many years of paid experience do you have?</label>
            <input
                className="application_input"
                type="text"
                id="experience"
            ...
            <label htmlFor="experiencetwo">Are you the owner or employee of a registered company/business?</label>
            <input
                className="application_input"
                type="text"
                id="experiencetwo"
